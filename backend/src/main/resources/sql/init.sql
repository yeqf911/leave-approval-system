...
(
    ...
    type varchar(255),
    reason varchar(255),
    status enum ('ASSIGNED_TO_INSTRUCTOR','ASSIGNED_TO_ACADEMY','ASSIGNED_TO_TEACHER', 'APPROVED') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'ASSIGNED_TO_INSTRUCTOR',
